module From = Types_409.Types
module To = Types_410.Types
...
module Asttypes = struct
  ...
  let copy_mutable_flag = Migrate_409_410.copy_mutable_flag

  let copy_private_flag = Migrate_409_410.copy_private_flag

  let copy_arg_label = Migrate_409_410.copy_arg_label

  let copy_virtual_flag = Migrate_409_410.copy_virtual_flag
end

module Parsetree = struct
  let copy_attributes = Migrate_parsetree.Migrate_409_410.copy_attributes
end
