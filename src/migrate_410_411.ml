module From = Types_410.Types
module To = Types_411.Types
...
module Asttypes = struct
  ...
  let copy_mutable_flag = Migrate_410_411.copy_mutable_flag

  let copy_private_flag = Migrate_410_411.copy_private_flag

  let copy_arg_label = Migrate_410_411.copy_arg_label

  let copy_virtual_flag = Migrate_410_411.copy_virtual_flag
end

module Parsetree = struct
  let copy_attributes = Migrate_parsetree.Migrate_410_411.copy_attributes
end

module Type_immediacy = struct
  let copy_t : Type_immediacy_410.t -> Type_immediacy_411.t = function
    | Unknown -> Unknown
    | Always -> Always
...
and copy_type_declaration : From.type_declaration -> To.type_declaration =
 fun {
     ...
     } ->
  {
    ...
    type_immediate = Type_immediacy.copy_t param_11;
